# Packer configuration for image basic-rhel-9 generated by PackerEbsImageBuilder (pckr-ebs-ans)
data "amazon-ami" "basic-rhel-9_aws-east2-runtime" {
    filters = {
...
source "amazon-ebs" "basic-rhel-9" {
    source_ami = data.amazon-ami.basic-rhel-9_aws-east2-runtime.id
    ami_name = "basic-rhel-9-aws-east2-runtime-20260826_120000"
    ...
    tags = {
        ...
        csis_fingerprint    = "4fa3f8488c398951",
