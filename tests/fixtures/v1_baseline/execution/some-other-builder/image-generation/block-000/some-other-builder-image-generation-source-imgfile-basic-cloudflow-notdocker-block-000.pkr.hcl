# Packer configuration for image imgfile-basic-cloudflow-notdocker generated by PackerEbsImageBuilder (some-other-builder)
data "amazon-ami" "imgfile-basic-cloudflow-notdocker_aws-east2-runtime" {
    owners = [
        "self",
    ]
    filters = {
        name                = "basic-rhel-9-aws-east2-runtime*",
...
source "amazon-ebs" "imgfile-basic-cloudflow-notdocker" {
    ...
    ami_name = "imgfile-basic-cloudflow-notdocker-pckr-ebs-ans-20260826_120000"
    ...
    tags = {
        ...
        csis_fingerprint    = "8bf22f4c15d2cc8b",
