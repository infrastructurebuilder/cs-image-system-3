...
data "amazon-ami" "imgfile-basic-dask_aws-east2-runtime" {
    ...
    filters = {
        name                = "basic-rhel-8-aws-east2-runtime*",
...
source "amazon-ebs" "imgfile-basic-dask" {
    ...
    ami_name = "imgfile-basic-dask-pckr-ebs-ans-20260826_120000"
    ...
    tags = {
        ...
        csis_parent         = "series:basic-rhel-8",
        csis_run            = "2026_08_26t12_00_00",
        csis_fingerprint    = "f7680371d97efc9e",
