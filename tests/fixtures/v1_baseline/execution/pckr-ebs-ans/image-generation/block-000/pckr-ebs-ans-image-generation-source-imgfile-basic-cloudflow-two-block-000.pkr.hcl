# Packer configuration for image imgfile-basic-cloudflow-two generated by PackerEbsImageBuilder (pckr-ebs-ans)
data "amazon-ami" "imgfile-basic-cloudflow-two_aws-east2-runtime" {
    owners = [
        "self",
    ]
    filters = {
...
source "amazon-ebs" "imgfile-basic-cloudflow-two" {
    ...
    ami_name = "imgfile-basic-cloudflow-two-pckr-ebs-ans-20260826_120000"
    ...
    tags = {
        ...
        csis_fingerprint    = "253e6d67c8fd2e9a",
